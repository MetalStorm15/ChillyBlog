...
一般情况下一个文本编辑器可以完成所有的语言的需求，VS Code也是一样，但是我没有那么多功夫去搞，也确实很麻烦，我到现在都没有办法把VS Code调到和Intellij IDEA一样的功能，很多东西我还是很想念IDEA。再加上C在VS code上面太难配置了，我懒得配置，就直接CLion上了，Java和Python我觉得Intellij IDEA更好用一些，很多细节很人性化。
